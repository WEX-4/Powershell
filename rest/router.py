...
from get_fact import get_route # TODO: (Task P0.3) Import the get_route function from the get_fact module
...
def create_app():
    ...
    app.add_url_rule('/generate', view_func=get_route, methods=["GET"])   # TODO: (Task P0.3) Add a URL rule for the generate route
